...
void page15pwm() {
  ...
  sfPlayISamples( MASK_LEFT_ELBOW, &(pwmElbow[0]), 30 );
  sfPlayISamples( MASK_LEFT_CLAVICLE, &(pwmClavicle[0]), 30 );
  // - переключение интерпретации значений на углы
  sfPlaySample( MASK_LEFT_ELBOW | MASK_LEFT_CLAVICLE, SV_MOTOR_PWM_OFF, 3 );
  ...
  sfPlaySample( MASK_LEFT_ELBOW, 2286, 3 );
  sfPlaySample( MASK_LEFT_CLAVICLE, 1536, 3 );
  sfWaitFrame( 6 );
